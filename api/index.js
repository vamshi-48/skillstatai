          ...
          messages: [
            {
              role: 'system',
              content:
                'You generate accurate skill assessments in valid JSON. Distribute correct answer indices across all positions (0, 1, 2, 3) so that questions do not have the same answer position.',
            },
